...
public class RepositoryException extends GeneralException {
	...
	public RepositoryException(String msg, GeneralError generalError) {
		super(msg, generalError);
	}

	public RepositoryException(String msg, GeneralError generalError, Throwable cause) {
		super(msg, generalError, cause);
	}

	public RepositoryException(String msg, GeneralError generalError, HttpStatus httpStatus) {
		super(msg, generalError, httpStatus);
	}

	public RepositoryException(String msg, GeneralError generalError, HttpStatus httpStatus, Throwable cause) {
